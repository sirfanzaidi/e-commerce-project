...
export type Order = {
  ...
  _rev: string;
  orderNumber?: string;
  stripeCheckoutSessionsId?: string;
...
// Variable: ALL_PPODUCTS_QUERY
// Query: *[_type == "product"]| order(name asc)
export type ALL_PPODUCTS_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: PPODUCT_BY_ID_QUERY
// Query: *[_type == "product" && slug.current == $slug] | order(name asc) [0]
export type PPODUCT_BY_ID_QUERYResult = {
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
