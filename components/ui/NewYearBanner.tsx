...
async function NewYearBanner() {
  const sale = await getActiveSaleByCouponCode(COUPON_CODES.NEWYEAR);
  if (!sale?.isActive) {
    return null;
  }
  <NewYearBanner />;
    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex-1">
          ...
          <div className="flex">
            <div className="bg-white text-black py-4 px-6 rounded-full shadow-md transform hover:sclae-105 transition duration-300">
